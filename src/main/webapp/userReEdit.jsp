...
<div class="area row">
    ...
    <div class="area grow-1">
        <h1>新闻编辑</h1>
        <img src="data:image/png;base64,${photo}" alt="" style="width: 160px;height: 160px;border: 1px solid aquamarine; border-radius: 10px">


        <form action="reEditSubmit" method="post" enctype="multipart/form-data">
            <div class="form-group row" hidden>
                <label for="inputId" class="col-sm-2 col-form-label myfont" hidden>id</label>
                <div class="col-sm-6"hidden>
                    <input type="text" class="form-control" id="inputId" name="id" value="${news.id}" hidden>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputTitle" class="col-sm-2 col-form-label myfont" >标题</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputTitle" placeholder="请输入标题" name="title" value="${news.title}">
                </div>
            </div>
<%--            <div class="form-group row">--%>
...
<%--            </div>--%>
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="inputContent" class="form-control" rows="15"  >${news.content}</textarea>
            </div>
